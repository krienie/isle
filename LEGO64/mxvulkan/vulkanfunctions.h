...
// Taken from Unreal Engine for convenience
...
// List all instance Vulkan entry points that need to be loaded manually
...
// List all surface Vulkan entry points that need to be loaded manually
...
// List all base Vulkan entry points that need to be loaded manually
...
// List all optional Vulkan entry points that need to be loaded manually
...
// List all optional Vulkan raytracing entrypoints
...
#define ENUM_VK_ENTRYPOINTS_PLATFORM_INSTANCE(EnumMacro) EnumMacro(PFN_vkCreateXcbSurfaceKHR, vkCreateXcbSurfaceKHR)
#elif defined VK_USE_PLATFORM_XLIB_KHR
#define ENUM_VK_ENTRYPOINTS_PLATFORM_INSTANCE(EnumMacro) EnumMacro(PFN_vkCreateXlibSurfaceKHR, vkCreateXlibSurfaceKHR)
#endif

//TODO(KL): Create versions for other OS
