...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
	...
	//							 "\"LEGO Island\" is not detecting a DirectSound compatible sound card.  Please quit all other "
	//							 "applications and try again.", nullptr);
	//	return 0;
	//}
	...
	SDL_Window* window = g_isle->GetWindowHandle();
...
BOOL FindExistingInstance()
{
	//TODO(KL): Make this implementation more cross-platform
